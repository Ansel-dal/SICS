...
builder.Services.AddDbContext<SicsContext>(options =>
{
    options.UseSqlServer(builder.Configuration.GetConnectionString("CadenaSICSSQL"));
});
builder.Services.AddAutoMapper(typeof(AutoMapperProfile));


builder.Services.AddScoped<IUsuarioRepositorio, UsuarioRepositorio>();
builder.Services.AddScoped<IConsumidorRepositorio, ConsumidorRepositorio>();
...
builder.Services.AddScoped<IIdentificadoresRepositorio, IdentificadoresRepositorio>();
